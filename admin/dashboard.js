...
$$(".sidebar-link").forEach(function(l){l.addEventListener("click",function(e){
  ...
  var h=$("#section-title");if(h)h.textContent={general:"Datos Empresa",logo:"Logo",images:"Imágenes",texts:"Textos",services:"Servicios",testimonials:"Testimonios",faq:"FAQ",messages:"Mensajes","email-config":"Email / SMTP",map:"Mapa"}[sec]||sec;
